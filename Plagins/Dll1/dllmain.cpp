...
void DrawButtonParallelogram(HDC hdc, RECT r) {//функция рисования на кнопке 
    ...
    p = { 18,6 }; points.push_back(p);
    p = { 22,22 }; points.push_back(p);
    p = { 8,22 }; points.push_back(p);
...
public:
    ...
    void Draw(HDC hdc) {
        ...
        int dw = w * 0.3;
        POINT points[4] = { {baseRect.left + dw,baseRect.top},{baseRect.right - dw,baseRect.top},{baseRect.right,baseRect.bottom},{baseRect.left,baseRect.bottom}};
